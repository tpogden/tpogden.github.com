...
var lineThicknessCorrection = 0.0
...
function initGame(canvasElement, StickCountElement, crossCountElement, estimateElement, 
    errorPercentElement, numSticksSelectElement, numSticksElement) {
    if (!canvasElement) {
